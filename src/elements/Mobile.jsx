    ...
    render(){
        return(
            <React.Fragment>
                ...
                {/* Start Pagehelmet  */}
                <PageHelmet pageTitle='Mobile Development' />
                {/* End Pagehelmet  */}
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient">MOBILE DEVELOPMENT</h2>
                                    ...
                                    <div className="inner">
                                        ...
                                        <div className="row sercice-details-content pb--80 align-items-center">
                                            <div className="col-lg-6 col-12">
                                                <div className="thumb">
                                                    <img className="w-100" src="/assets/images/service/mobile.png" alt="Service Images"/>
                                                </div>
                                            </div>
                                            <div className="col-lg-6 col-12">
                                                <div className="details mt_md--30 mt_sm--30">
                                                    <p>we have collaborated with several well-known companies 
                                                        to create more than 15 mobile app projects for domestic and 
                                                        international markets. With a team of long-term experienced IT 
                                                        experts including Mobile App Developers, UI/UX Designers, QA/QC, 
                                                        and Project Managers, and a deep understanding of mobile app development 
                                                        as well as user insights, we offer 4 solutions to deliver the fittest product 
                                                        for your business:.</p>
